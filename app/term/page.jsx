    ...
    return (
        <>
            ...
            <>
                ...
                <section
                    className="u-align-center u-clearfix u-image u-section-1 mt-10 myBB"
                    id="sec-9a83"
                    ...
                    <div className="u-clearfix u-sheet u-valign-middle u-sheet-1">
                        <div className="u-align-center u-container-style u-group u-group-1">
                            <div className="u-container-layout u-valign-middle">
                                ...
                                <h2 className="u-text u-text-1" style={{ fontFamily: '"Futura", sans-serif', fontWeight: "bolder", marginBottom: "1em", fontSize: "3em" }}>Terms and Conditions</h2>
                                <p className="u-text u-text-2" style={{ fontFamily: 'Frank Ruhl Libre, "PT Serif", "Noto Serif", "Noto Serif JP", "Noto Serif KR", "Noto Serif SC", "Noto Serif TC", ui-serif, Georgia, Cambria, Times New Roman, Times, serif', fontSize: "1.2rem", lineHeight: "2rem", fontWeight: "400" }}>
                                    ...
                                    By using this website, you agree to comply with and be bound by the following terms and conditions of use, which together with our privacy policy govern Rafi Daham - Hair Repair Studio’s relationship with you in relation to this website. The term Rafi Daham - Hair Repair Studio or ‘us’ or ‘we’ refers to the owner of the website. The term ‘you’ refers to the user or viewer of our website.
