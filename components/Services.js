      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3">
        {services.map((service, index) => (
          <div key={service.id || index} className="text-center">
            ...
            <h5 className="uppercase mypar11223 mb-3">{service.title}</h5>
            <p className=" my-2">{service.description}</p>
            <button
              className="text-[12px] uppercase mt-4 mb-10 px-6 py-3 bg-[#7c7974] hover:bg-[#444444] text-white transition-all duration-300 transform hover:scale-105"
