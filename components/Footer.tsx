                    ...
                    >
                        <ul>
                            ...
                            {/* <li>
                                <a
                                    target="_blank"
                                    href="https://www.instagram.com/Rafi Daham - Hair Repair Studio.lb/"
                                    data-auto-id="true"
                                    id="page-footer-http-www-instagram-com-bellroy-1"
                                >
                                    <svg
                            ...
                            <div className="column mb-5"  >
                                <p className="question">
                                    ...
                                    <span>
                                        Contact{" "}
                                        <a
                                            href="mailto:info@Rafi Daham - Hair Repair Studio-lb.com"
                                            data-auto-id="true"
                                            id="page-footer-mailto-support-bellroy-com-1"
                                        >
                                            info@Rafi Daham - Hair Repair Studio-lb.com
                                        </a>
                                    </span>
                                </p>
                            </div>
