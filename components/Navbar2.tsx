    ...
    <>
      ...
      <div className="pageHeaderContainer">
        ...
        <div className="pageHeaderMenuPreHeader" id="PageMenuPreHeader">
          <a
            href="/"
            className="br_absolute br_left-1/2 br_top-1/2 br_-translate-y-1/2 br_-translate-x-1/2 xl:pointer-fine:br_absolute xl:pointer-fine:br_left-8 xl:pointer-fine:br_top-6 xl:pointer-fine:br_p-0 xl:pointer-fine:br_m-0 xl:pointer-fine:br_transform-none all-link-states:br_text-black"
            data-roybell=""
          ...
          >
            <ul className="xl:pointer-fine:br_flex xl:pointer-fine:br_pl-[155px]">
              ...
              <li className="br_group/item">
                ...
                >
                  <div className="br_flex br_items-center br_gap-2">Videos</div>
                </a>
