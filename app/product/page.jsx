...
const Page = () => {
  ...
  return (
    <>
      <head>
        <meta property="og:title" content="Rafi Daham - Hair Repair Studio" />
        <meta property="og:url" content="https://abbasbaba.com/" />
        <meta property="og:site_name" content="At Rafi Daham - Hair Repair Studio, we're reshaping the way businesses connect." />
